...
class User extends Authenticatable implements HasMedia
{
     ...
     */
    protected $fillable = [
        'first_name', 'last_name', 'email', 'password', 'username', 'contact_number', 'gender', 'email_verified_at', 'address', 'user_type', 'player_id', 'fcm_token', 'fleet_id', 'latitude', 'longitude', 'last_notification_seen', 'status', 'is_online', 'is_available', 'uid', 'login_type', 'display_name', 'timezone', 'service_id', 'is_verified_driver', 'ref_code', 'applied_ref_code', 'last_location_update_at'
    ];
    ...
    {
        return $this->belongsToMany(Bonus::class)->withTimestamps()->withPivot(['amount', 'status']);
    }
}
