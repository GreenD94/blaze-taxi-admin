...
class Payment extends Model
{
    ...
    protected $fillable = [ 'rider_id', 'ride_request_id', 'datetime', 'total_amount', 'admin_commission', 'driver_commission', 'received_by', 'driver_fee', 'driver_tips', 'fleet_commission', 'payment_type', 'txn_id', 'payment_status', 'transaction_detail',  'collected_cash' ];
