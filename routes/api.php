...
Route::post('check-ref-code',[API\UserController::class, 'checkRefCode']);
...
Route::get('referrals-enabled', [ API\UserController::class, 'checkReferralsEnabled'] );
...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::get('referral-info', [ API\DashboardController::class, 'getReferralInfo'] );
