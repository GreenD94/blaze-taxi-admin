                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            @else
                                @hasanyrole('admin|demo_admin')
                                    ...
                                    <li class="nav-item">
                                        <a href="javascript:void(0)" data-href="{{ route('layout_page') }}?page=referrals-setting" data-target=".paste_here" class="nav-link {{$page=='referrals-setting'?'active':''}}"  data-toggle="tabajax" rel="tooltip"> {{ __('message.referrals_settings') }}</a>
                                    </li>
