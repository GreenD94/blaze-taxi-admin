...
class DriverResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $requiredDocCount = Document::where('is_required', 1)->where('status', 1)->count();
        $driverDocuments = $this->driverDocument->load('document')->filter( function($driverDocument) {
            return $driverDocument->document->is_required ?? false;
        })->count();
        ...
        return [
            ...
            'is_document_required' => $requiredDocCount - $driverDocuments,
