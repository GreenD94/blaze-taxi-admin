...
Route::group(['middleware' => ['auth', 'verified', 'admin']], function()
{
    ...
    Route::post('notification/send',[ NotificationController::class ,'makeSend'])->name('notification.send');

    Route::get('notification/send/test',[ NotificationController::class ,'testNotification'])->name('notification.send.test');
