...
class RideRequest extends Model
{
    ...
    protected $fillable = [ 'rider_id', 'service_id', 'datetime', 'is_schedule', 'ride_attempt', 'distance_unit', 'total_amount', 'subtotal', 'extra_charges_amount', 'driver_id', 'start_latitude', 'start_longitude', 'end_latitude', 'start_address', 'end_longitude', 'end_address', 'distance', 'duration', 'seat_count', 'reason', 'status', 'base_fare', 'minimum_fare', 'base_distance', 'per_distance', 'per_distance_charge', 'per_minute_drive', 'per_minute_drive_charge', 'payment_type', 'extra_charges', 'tips', 'cancel_by', 'cancelation_charges', 'coupon_discount','coupon_code', 'coupon_data', 'otp', 'waiting_time_limit', 'waiting_time', 'per_minute_waiting', 'per_minute_waiting_charge', 'cancelled_driver_ids', 'service_data', 'max_time_for_find_driver_for_ride_request', 'proposed_fee', 'is_rider_rated', 'is_driver_rated', 'riderequest_in_driver_id', 'riderequest_in_datetime', 'cash_in_hand', 'cash_collected', 'modality' ];
    ...
    /**
     * Get all of the offerings for the RideRequest
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     */
    public function offerings(): HasMany
    {
        return $this->hasMany(RideRequestOffering::class, 'ride_request_id', 'id');
    }

    /**
     * Get the cancellation associated with the RideRequest
     *
