...
<div class="d-flex justify-content-end align-items-center">
    ...
    <a class="mr-2 loadRemoteModel" href="{{ route('rider.wallet', $id) }}" title="{{ __('message.update_form_title',['form' => __('message.wallet') ]) }}"><i class="fas fa-wallet text-primary"></i></a>
