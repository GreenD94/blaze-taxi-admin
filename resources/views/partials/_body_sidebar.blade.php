@php
    ...
    $MyNavBar = \Menu::make('MenuList', function ($menu) use($url){
        ...
        $menu->add('<span>'.__('message.notification').'</span>', [ 'class' => '', 'route' => 'notification.create'])
        ...
        $menu->add('<span>'.__('message.bonus').'</span>', ['route' => 'bonus.index'])
                ->prepend('<i class="fas fa-money-bill"></i>')
                ->nickname('bonuses')
                ->data('permission', 'bonus');

        $menu->add('<span>'.__('message.banner').'</span>', ['route' => 'banner.index'])
                ->prepend('<i class="fas fa-sign"></i>')
                ->nickname('banners')
                ->data('permission', 'banner');
